        ...
        for fig_x, design in enumerate(row_layout):
            ...
            if design == 'None':
                ...
                for i, sim in enumerate(simulators):
                    sim_marker = plot_styles.simulator_markers[sim]
                    sim_color = plot_styles.simulator_colors[sim]

                    sim_linestyle = plot_styles.simulator_linestyle[sim]
                    ...
                    for ncpu in parallel_cpus:
                        try:
                            throughput = log_parser.get_throughput_data(sim, design, benchmark, ncpu, settings.iterations)
