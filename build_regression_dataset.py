...
throughput logs and dedup_features_all.csv.
...
Usage:
    python3 build_regression_dataset.py SWEEP_DIR [--features CSV] [-o OUTPUT]

    SWEEP_DIR: directory containing rank*/manifest.txt + rank*/throughput_logs/
               e.g. all_parallel/20260410_192340/

Examples:
    python3 build_regression_dataset.py all_parallel/20260410_192340/
    python3 build_regression_dataset.py all_parallel/20260410_192340/ --features dedup_features_all.csv -o regression_dataset.csv
"""
...
FEATURES_CSV = SCRIPT_DIR / "dedup_features_all.csv"
OUTPUT_CSV = SCRIPT_DIR / "regression_dataset.csv"
...
# ---------------------------------------------------------------------------
# Log parsing (from parse_slim_sweep.py)
# ---------------------------------------------------------------------------
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "sweep_dir",
        type=Path,
        help="Sweep directory containing rank*/manifest.txt (e.g. all_parallel/20260410_192340/)",
    )
    p.add_argument(
